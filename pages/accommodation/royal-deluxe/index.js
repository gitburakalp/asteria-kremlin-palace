...
class RoyalDeluxe extends React.Component {
  render() {
    const { t, lang } = this.props;
    const roomName = 'Royal Deluxe';
...
RoyalDeluxe.getInitialProps = async ({ req }) => {
...
RoyalDeluxe.propTypes = {
  t: PropTypes.func.isRequired,
};

export default withTranslation('common')(RoyalDeluxe);
